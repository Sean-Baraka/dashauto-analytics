...
app.layout = dbc.Container([
    ...
    dbc.Tabs(id="main-tabs", active_tab="upload", children=[
        dbc.Tab(label="📤 Upload Data", tab_id="upload", children=upload_layout()),
    ...
    html.Br(),
    dbc.Footer(
        "Postgraduate Diploma Project 2026 | DATA APPLICATION FOR AUTOMATED DATA ANALYTICS AND VISUALIZATION USING DASHAPP",
